import getReview from '@wasp/queries/getReview'
import getStrains from '@wasp/queries/getStrains'
import { useQuery } from '@wasp/queries'
import Header from './Header.jsx'

const ReviewPage = (props) => {
    const { data: review, isFetching, error } = useQuery(getReview, {id: parseInt(props.match.params.id)})
